...
export default function ProjectCard() {
  ...
  return (
    <div className="border-[1px] border-zinc-600 pb-6 px-6 sm:flex sm:items-center sm:justify-center sm:space-x-4 sm: py-4 lg:max-w-[36rem]">
        <Image
          src={"/demopic.png"}
          height={500}
          width={500}
        ...
        <div className=" max-w-[20rem] mx-auto space-y-2">
